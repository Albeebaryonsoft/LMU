...
high_vif <- names(v[v > 5])      # moderate–high collinearity
very_high_vif <- names(v[v >10]) # critical collinearity
...
Step 1: candidate covariates selection. 
...
Step 2: Linear Regression Model Construction and Multicollinearity Assessment

In the second step, we fitted a multivariable linear regression model using the 15 pre-selected covariates. 
