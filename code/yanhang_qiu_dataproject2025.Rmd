...
Diagnostic 4: Outliers (Residuals vs Leverage, Cook’s Distance)
...
Diagnostic 5: Independence of Residuals (Durbin–Watson Test)
...
CI_Wilson <- binom.confint(cancer, tot, conf.level = 0.95, methods = "wilson")
CI_Wilson
